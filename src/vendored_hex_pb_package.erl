...
-export_type(['Dependency'/0, 'RetirementStatus'/0, 'Release'/0, 'Package'/0]).

-spec encode_msg('Dependency'() | 'RetirementStatus'() | 'Release'() | 'Package'(),'Dependency' | 'RetirementStatus' | 'Release' | 'Package') -> binary().
encode_msg(Msg, MsgName) ->
    encode_msg(Msg, MsgName, []).


-spec encode_msg('Dependency'() | 'RetirementStatus'() | 'Release'() | 'Package'(),'Dependency' | 'RetirementStatus' | 'Release' | 'Package', list()) -> binary().
...
get_msg_names() ->
    ['Dependency', 'RetirementStatus', 'Release',
     'Package'].
